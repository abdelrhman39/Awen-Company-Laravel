		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-contacts"></span> {{ __('lang.Ads') }}
				</div>
		...
		<div class="col-12 py-2 px-2 row justify-content-between">
			...
			<div class="col-12 col-lg-4 px-2 justify-content-end d-flex mb-2">
	 			...
	 			<a href="{{route('admin.announcements.create')}}">
	 				<button class="btn btn-primary pb-2 rounded-0"><span class="fas fa-plus"></span> {{ __('lang.Add new') }}</button>
	 			</a>
	 			@endcan
	 		</div>
		</div>
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td class=" row d-flex">
		      	...
		      	<a href="#" style="width: 30px;height: 30px;color: #fff;background: #c00;border-radius: 2px" class="d-flex align-items-center justify-content-center mx-1" onclick='var result = confirm({{ __("lang.are sure of the deleting process ?") }});if (result) {$("#announcement_delete_{{$announcement->id}}").submit();}'>
