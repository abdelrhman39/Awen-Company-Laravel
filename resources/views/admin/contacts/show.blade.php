    ...
    <div class="col-12 py-0 px-3 row">
        <div class="col-12  pt-4" style="background: #fff;min-height: 80vh">
            <div class="col-12 px-3">
                <h5>{{ __('lang.Display number message') }} {{ $contact->id }} {{ __('lang.coming from') }}
                    {{ $contact->name }}</h5>
            </div>
                                ...
                                @if ($contact->user_id != null)
                                    <a href="{{ route('admin.users.index', ['id' => $contact->user_id]) }}"
                                        ...
                                        <img src="{{ $contact->user->getUserAvatar() }}"
                                            ...
                                            class="mx-auto" alt="{{ __('lang.Profile image') }}">
            ...
            <div class="col-12  px-3 py-1 mt-4">
                <form method="POST" action="{{ route('admin.contact-replies.store') }}">
                    ...
                    <div class="col-12 p-0">
                        <button class="btn btn-primary">{{ __('lang.send reply') }}</button>
                    </div>
                </form>
            </div>
        </div>
