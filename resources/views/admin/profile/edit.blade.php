  ...
  <div class="modal-dialog" style="width:394px;max-width: 100%">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="changeAvatarLabel">{{ __('lang.change profile Image') }}</h5>
        ...
        <div class="col-12 p-2" style="background: #fff;overflow: hidden;position: relative;max-width: 100%!important">
            ...
            <div class="col-12 text-left
             mt-3">
                ...
                <button class="btn btn-primary mx-1 font-1 save-image" >{{ __('lang.change Image') }}</button>
            </div>
        </div>
					...
					<div class="col-12 p-0 main-box shadow">
						<div class="col-12 px-0">
							<div class="col-12 px-3 py-3">
							 	<span class="fal fa-info-circle"></span>	{{ __('lang.basic information') }}
							</div>
            ...
            <div class="col-12 col-lg-6 my-2">
                <form method="POST" action="{{route('admin.profile.update-email')}}" >
                    ...
                    <div class="col-12 p-0 main-box shadow">
                        <div class="col-12 px-0">
                            <div class="col-12 px-3 py-3">
                                <span class="fal fa-envelope"></span> {{ __('lang.change email') }}
                            </div>
                            <div class="col-12 divider" style="min-height: 2px;"></div>
                        </div>
                        <div class="col-12 p-3">
                            ...
                            <div class="col-12 p-2">
                                <div class="col-12 pt-3">
                                    <button class="btn btn-primary">{{ __('lang.change email') }}</button>
            ...
            <div class="col-12 col-lg-6 my-2">
                <form method="POST" action="{{route('admin.profile.update-password')}}" >
                    ...
                    <div class="col-12 p-0 main-box shadow">
                        <div class="col-12 px-0">
                            <div class="col-12 px-3 py-3">
                                <span class="fal fa-key"></span>  {{ __('lang.password') }}
                            </div>
                            <div class="col-12 divider" style="min-height: 2px;"></div>
                        </div>
                        <div class="col-12 p-3">
                            <div class="col-12 p-2">
                                <div class="col-12 pt-3">
                                    <div class="alert alert-warning">
                                        {{ __('lang.It is preferable to use a password consisting of letters, numbers and special signs such as') }} ( % $ # @ )
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 p-2">
                            ...
                            <div class="col-12 p-2">
                                <div class="col-12 pt-3">
                                    <button class="btn btn-primary">{{ __('lang.Confirm new Password') }}</button>
