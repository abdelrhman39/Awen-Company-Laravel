		...
		<div class="col-12 col-lg-8 p-0 main-box">
			<div class="col-12 px-0">
				<div class="col-12 px-3 py-3">
				 	<span class="fas fa-info-circle"></span> {{ __('lang.Edit redirect link') }}
				</div>
			...
			<div class="col-12 p-3 row">
				...
				<div class="col-12 col-lg-6 p-2">
					<div class="col-12">
						{{ __('lang.redirection type') }}
					</div>
					<div class="col-12 pt-3">
						<select name="code" required class="form-control">
							<option value selected disabled hidden>{{ __('lang.Choose redirection type') }}</option>
