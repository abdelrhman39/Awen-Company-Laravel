<div>
    <div class="col-12 row m-0">
        <div class="col-12 pt-2 row d-flex justify-content-center ">
            ...
            <div class="col-12 d-flex justify-content-center align-items-center" style="height: 300px;">
                <div class="col-12 d-inline-block text-center">
                    <span class="fal fa-images font-12" style="color:#ff9800"></span><br><br> <span class="fas fa-info-circle"></span>  {{ __('lang.No files') }}
                </div>
            </div>
            @endif
        </div>
        ...
        <div class="col-12 py-2 px-3 d-flex justify-content-end mb-3">
            <span class="d-inline-block btn btn-light btn-sm mx-2" data-bs-dismiss="modal">{{ __('lang.Back') }}</span>
            <span class="d-inline-block btn btn-primary btn-sm" id="selected-files-insert-btn" data-bs-dismiss="modal"><span class="far fa-check-circle"></span> {{ __('lang.Choose files') }}</span>
        </div>
    </div>
</div>
